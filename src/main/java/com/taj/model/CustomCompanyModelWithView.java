...
public class CustomCompanyModelWithView {
    ...
    public CustomCompanyModelWithView(byte[] image_one, byte[] image_two, byte[] image_third, byte[] image_four, @NotNull @NotBlank @NotEmpty @Size(max = 450, min = 1, message = "title should have at least 1 characters") String offer_title, @NotNull @NotBlank @NotEmpty @Size(max = 450, min = 1, message = "explian should have at least 1 characters") String offer_explaination, @Min(1) double offer_cost, @NotNull Long offer_display_date, @NotNull Long offer_expired_date,
