...
public class NewProfileModel {
    ...
    public NewProfileModel(int companyId, @NotNull @NotBlank @NotEmpty @Size(max = 450, min = 1, message = "company_name should have at least 1 characters") String companyName, @NotNull byte[] companyLogoImage, @NotNull @NotBlank @NotEmpty @Size(max = 450, min = 1, message = "address should have at least 1 characters") String companyAddress, String companyLinkYoutube, @NotNull @NotBlank @NotEmpty @Size(max = 450, min = 1, message = "website should have at least 1 characters") String companyWebsiteUrl, float companyLng, float companyLat,
                           @NotNull byte[] companyCoverImage, String companyPhoneNumber, int followerCount, int orderCount, String companyDesc, int categoryNum, String city, String area) {
