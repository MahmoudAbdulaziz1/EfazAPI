...
public class CompanyHistoryDto {
    ...
    public CompanyHistoryDto(int offer_id, byte[] image_one, byte[] image_two, byte[] image_three, byte[] image_four, String offer_title, String offer_explaination, double offer_cost, long offer_display_date,
