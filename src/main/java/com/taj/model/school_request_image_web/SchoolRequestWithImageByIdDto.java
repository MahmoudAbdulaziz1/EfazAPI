...
public class SchoolRequestWithImageByIdDto {
    ...
    public SchoolRequestWithImageByIdDto(int request_id, @NotNull @NotBlank @NotEmpty @Size(max = 450, min = 1, message = "title should have at least 1 characters") String request_title, @NotNull @NotBlank @NotEmpty @Size(max = 450, min = 1, message = "explain should have at least 1 characters") String request_explaination, @NotNull long request_display_date, @NotNull long request_expired_date,
                                         int school_id, String school_name, byte[] school_logo_image, @NotNull String request_category_name, @NotNull int response_count, int views_count, byte[] image_one) {
