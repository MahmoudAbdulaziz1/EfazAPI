...
public class schoolRequestWithImageDto {
    ...
    public schoolRequestWithImageDto(int request_id, @NotNull @NotBlank @NotEmpty @Size(max = 450, min = 1, message = "title should have at least 1 characters") String request_title, @NotNull @NotBlank @NotEmpty @Size(max = 450, min = 1, message = "explain should have at least 1 characters") String request_explaination, @NotNull long request_display_date, @NotNull long request_expired_date, @NotNull @Min(0) int request_is_available, @NotNull @Min(0) int request_is_conformied, @NotNull @Min(1) int school_id, String school_name, byte[] school_logo_image, @NotNull @Min(1) int request_category_id,
                                     String request_category_name, @NotNull @Min(0) int extended_payment, @Min(1) int request_count, int view_count, byte[] image_one) {
    ...
    public schoolRequestWithImageDto(@NotNull @NotBlank @NotEmpty @Size(max = 450, min = 1, message = "title should have at least 1 characters") String request_title, @NotNull @NotBlank @NotEmpty @Size(max = 450, min = 1, message = "explain should have at least 1 characters") String request_explaination, @NotNull long request_display_date, @NotNull long request_expired_date, @NotNull @Min(0) int request_is_available, @NotNull @Min(0) int request_is_conformied, @NotNull @Min(1) int school_id, String school_name, byte[] school_logo_image, @NotNull @Min(1)
    int request_category_id, String request_category_name, @NotNull @Min(0) int extended_payment, @Min(1) int request_count, int view_count, byte[] image_one) {
        this.request_title = request_title;
        this.request_explaination = request_explaination;
        this.request_display_date = request_display_date;
        this.request_expired_date = request_expired_date;
