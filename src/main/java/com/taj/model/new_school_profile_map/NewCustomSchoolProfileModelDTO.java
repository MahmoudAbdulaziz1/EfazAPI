...
public class NewCustomSchoolProfileModelDTO {
    ...
    public NewCustomSchoolProfileModelDTO(@Min(1) int school_id, @NotNull @NotBlank @NotEmpty @Size(max = 450, min = 1, message = "name should have at least 1 characters") String school_name, @NotNull byte[] school_logo_image, @NotNull @NotBlank @NotEmpty @Size(max = 450, min = 1, message = "address should have at least 1 characters") String school_address, String school_service_desc, @NotNull @NotBlank @NotEmpty @Size(max = 450, min = 1, message = "service should have at least 1 characters") String school_link_youtube, @NotNull @NotBlank @NotEmpty @Size(max = 450, min = 1, message = "website should have at least 1 characters")
    String school_website_url, @NotNull byte[] school_cover_image, String school_phone_number, String area, String city, float lng, float lat) {
